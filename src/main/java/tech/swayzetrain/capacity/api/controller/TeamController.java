...
public class TeamController {
	...
	public ResponseEntity<List<RoleCapacity>> getTeamRoleCapcityByKey(@PathVariable("teamId") String teamId, @RequestParam(name = "startDate", required=false) @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate startDate, @RequestParam(name = "endDate", required=false) @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate endDate) {
		return teamCapacityService.getTeamRoleCapacity(sharedUtility.uuidFromString(teamId), startDate, endDate);
	}
	
	@GetMapping("/{teamId}/capacity/summary")
	public ResponseEntity<List<RoleCapacity>> getTeamRoleCapcitySummaryByKey(@PathVariable("teamId") String teamId, @RequestParam(name = "startDate", required=false) @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate startDate, @RequestParam(name = "endDate", required=false) @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate endDate) {
		return teamCapacityService.getTeamRoleCapacitySummary(sharedUtility.uuidFromString(teamId), startDate, endDate);
	}
